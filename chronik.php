...
<title>Pony Express - German Tail</title>

<!-- Bootstrap -->
<link
	href="http://cdn.livespawn.de/static/bootstrap/3_3_4/bootstrap.css"
	rel="stylesheet">
		...
		<div class="container-fluid container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li><a href="/">Start <span class="sr-only"></span></a></li>
        ...
        <li class="timeline-inverted">
          ...
          <div class="timeline-panel">
            ...
            <div class="timeline-body">
              <p>
              	<ul>
              		<li>Sebnitz ist Grenzübergang</li>
              		<li>Schwarzheide wurde nach Biehlen verlegt</li>
              		<li>Ruderboot auf Elbe bei Ferchland</li>
              	</ul>
              </p>
            </div>
          </div>
